...
defined in the data model, an object model base class is generated in `/dx-orm/generated`. A project's
complete data model consists of the base data model (which ships with divbloxjs and deals with core
functionality) combined with any data model(s) defined in the project's various Divblox packages.
